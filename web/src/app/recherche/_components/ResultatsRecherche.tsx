...
// LIMITE_RESULTATS, d'où la précision "(N affichés)" quand tronqué, pour
// ne pas laisser croire à un écart entre le chiffre annoncé et les cartes
// visibles à l'écran.
function formaterTitreSection(total: number, nbAffiches: number, tronque: boolean): string {
  return tronque ? `${total} (${nbAffiches} affichés)` : `${total}`;
}
