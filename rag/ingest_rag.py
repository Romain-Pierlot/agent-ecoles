...
META_CCOMPTES = {
    "dc_title":      "L'enseignement privé sous contrat — Rapport de la Cour des comptes",
    "dc_creator":    "Cour des comptes",
    "dc_publisher":  "Cour des comptes — République française",
    "dc_date":       "2023",
    "dc_type":       "rapport_public",
    "dc_source":     "https://www.ccomptes.fr/fr/publications/lenseignement-prive-sous-contrat",
    "chunk_domaine": "ivac",
...
CHUNKS_MANUELS = [
    ...
    {
        "id": "ccomptes_2023_prive_000",
        "contenu": "Résultats des collèges privés sous contrat : ce que dit la Cour des comptes (2023)\n\nLes résultats scolaires des établissements privés sous contrat sont globalement meilleurs que ceux du secteur public. Mais la Cour des comptes précise que cette performance reste difficile à mesurer car elle est fortement influencée par les populations accueillies.\n\nLe privé sous contrat scolarise une proportion croissante d'élèves favorisés : 55,5% d'élèves issus de familles favorisées ou très favorisées en 2021, contre 32,3% dans le public. La part des élèves boursiers y est de 11,8% contre 29,1% dans le public. La Cour identifie parmi les explications de ce déséquilibre les politiques de sélection des élèves pratiquées par certains établissements privés.\n\nEn conséquence, comparer les taux de réussite bruts d'un collège privé et d'un collège public sans tenir compte de leur profil social respectif ne permet pas d'évaluer leur efficacité pédagogique réelle.",
        "metadata": chunk_meta(META_CCOMPTES, "76-78", "Résultats scolaires et mixité sociale dans l'enseignement privé sous contrat"),
    },
]
